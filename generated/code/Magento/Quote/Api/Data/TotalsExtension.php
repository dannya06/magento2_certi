...
class TotalsExtension extends \Magento\Framework\Api\AbstractSimpleObject implements TotalsExtensionInterface
{
     ...
     * @return float|null
     */
    public function getAwStoreCreditAmount()
    {
        return $this->_get('aw_store_credit_amount');
    }

    /**
     * @param float $awStoreCreditAmount
     * @return $this
     */
    public function setAwStoreCreditAmount($awStoreCreditAmount)
    {
        $this->setData('aw_store_credit_amount', $awStoreCreditAmount);
        return $this;
    }
     ...
     * @return float|null
     */
    public function getBaseAwStoreCreditAmount()
    {
        return $this->_get('base_aw_store_credit_amount');
    }

    /**
     * @param float $baseAwStoreCreditAmount
     * @return $this
     */
    public function setBaseAwStoreCreditAmount($baseAwStoreCreditAmount)
    {
        $this->setData('base_aw_store_credit_amount', $baseAwStoreCreditAmount);
        return $this;
    }
