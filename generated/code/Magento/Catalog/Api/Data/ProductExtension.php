...
class ProductExtension extends \Magento\Framework\Api\AbstractSimpleObject implements ProductExtensionInterface
{
    ...
    /**
     * @return \Aheadworks\Giftcard\Api\Data\AmountInterface[]|null
     */
    public function getAwGiftcardAmounts()
    {
        return $this->_get('aw_giftcard_amounts');
    }

    /**
     * @param \Aheadworks\Giftcard\Api\Data\AmountInterface[] $awGiftcardAmounts
     * @return $this
     */
    public function setAwGiftcardAmounts($awGiftcardAmounts)
    {
        $this->setData('aw_giftcard_amounts', $awGiftcardAmounts);
        return $this;
    }

    /**
     * @return \Aheadworks\Giftcard\Api\Data\TemplateInterface[]|null
     */
    public function getAwGiftcardTemplates()
    {
        return $this->_get('aw_giftcard_templates');
    }

    /**
     * @param \Aheadworks\Giftcard\Api\Data\TemplateInterface[] $awGiftcardTemplates
     * @return $this
     */
    public function setAwGiftcardTemplates($awGiftcardTemplates)
    {
        $this->setData('aw_giftcard_templates', $awGiftcardTemplates);
        return $this;
    }
}
