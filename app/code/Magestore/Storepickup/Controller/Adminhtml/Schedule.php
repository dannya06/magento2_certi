 ...
 */
abstract class Schedule extends \Magestore\Storepickup\Controller\Adminhtml\AbstractAction
{
    /**
     * param id for crud action : edit,delete,save.
     */
    const PARAM_CRUD_ID = 'schedule_id';

    /**
     * registry name.
     */
    const REGISTRY_NAME = 'storepickup_schedule';
    ...
    protected function initPage($resultPage)
    {
        $resultPage->setActiveMenu('Magestore_Storepickup::storepickup')
            ...
            ->addBreadcrumb(__('Manage Schedule'), __('Manage Schedule'));
