        ...
        loadStore: function (params) {
            ...
            $.ajax({
                ...
                if (data.pagination) {
                    ...
                    var elPagination = self.$paginationWrapper.pagination();
                    elPagination.pagination('addChangePageEvent');
                }
                ...
                if (data.storesjson) {
                    ...
                    $.each(self.stores, function (index, store) {
                        store.index = index;
                        var elListstorebox = self.$liststoreBox.liststore();
                        elListstorebox.liststore('addStore', store);
