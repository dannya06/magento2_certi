 ...
 */
namespace Icube\SalesRule\Controller\Adminhtml\Promo\Quote;
        ...
        if ($data) {
            try {
                ...
                if($model->getData("is_active") == 0){
			        ...
			        $sql = "UPDATE " . $tableName . " SET coupon_code=NULL WHERE coupon_code = '" . $model->getData("coupon_code") . "'";$connection->query($sql);
                }
