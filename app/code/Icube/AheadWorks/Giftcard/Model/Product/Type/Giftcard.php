 ...
 */
namespace Icube\AheadWorks\Giftcard\Model\Product\Type;
...
class Giftcard extends AbstractType
{
    ...
    private function validateBuyRequest(DataObject $buyRequest, $product, $processMode)
    {
        ...
        if (!$this->isTypePhysical($product)) {
            ...
            if (!$buyRequest->getData(OptionInterface::TEMPLATE) && $this->_isStrictProcessMode($processMode) && !empty($buyRequest->getData(OptionInterface::TEMPLATE))) {
