 ...
 */
namespace Icube\Cms\Controller\Adminhtml\Wysiwyg\Images;
...
class OnInsert extends Images implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        // To handle the $data['force_static_path'] not null
        $data['force_static_path'] = (empty($data['force_static_path'])?"":$data['force_static_path']);
