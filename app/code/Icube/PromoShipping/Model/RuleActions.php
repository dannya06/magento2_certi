...
namespace Icube\PromoShipping\Model;

use Amasty\Rules\Helper\Data;
use Magento\Framework\Option\ArrayInterface;

class RuleActions extends \Amasty\Rgrid\Model\RuleActions
{
    ...
    {
        $options = [
            'shipping_disc_by_amount' => __('Fixed Shipping Amount Discount'),
            'shipping_disc_by_percent' => __('Percentage Shipping Amount Discount'),
