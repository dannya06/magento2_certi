...
namespace Amasty\PageSpeedOptimizer\Block\Adminhtml\System\Config;
...
class Information extends Fieldset
{
     ...
     * @var string
     */
    private $userGuide = 'https://amasty.com/docs/doku.php?id=magento_2%3Agoogle_page_speed_optimizer';
