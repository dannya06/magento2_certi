...
namespace Aheadworks\Layerednav\Block\Adminhtml\Page\Menu;

use Aheadworks\Layerednav\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\Layerednav\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_Layerednav::page/menu/item.phtml';
     ...
     * @return void
     */
    private function prepareLinkAttributes()
    {
