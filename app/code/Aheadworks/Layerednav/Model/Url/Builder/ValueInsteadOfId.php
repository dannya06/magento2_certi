 ...
 */
class ValueInsteadOfId implements BuilderInterface
{
    /**
     * @var ParserPool
     */
    ...
    public function getCurrentUrl($fromType)
    {
        ...
        $converter = $this->converterPool->getConverter($fromType, SeoFriendlyUrl::ATTRIBUTE_VALUE_INSTEAD_OF_ID);
    ...
    public function getCurrentCanonicalUrl()
    {
        ...
        return $this->url
            ->addQueryParams($converter->convertFilterParams($parts['filterParams']))
