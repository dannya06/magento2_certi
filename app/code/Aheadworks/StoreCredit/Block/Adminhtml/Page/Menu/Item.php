 ...
 */
namespace Aheadworks\StoreCredit\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\StoreCredit\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_StoreCredit::page/menu/item.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->isCurrent()) {
            /** @var \Aheadworks\StoreCredit\Block\Adminhtml\Page\Menu $menu */
