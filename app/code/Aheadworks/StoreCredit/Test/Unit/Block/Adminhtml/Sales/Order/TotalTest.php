 ...
 */
namespace Aheadworks\StoreCredit\Test\Unit\Block\Adminhtml\Sales\Order;

use Aheadworks\StoreCredit\Block\Adminhtml\Sales\Order\Total;
...
class TotalTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testInitTotalMethod()
    {
        ...
        $this->invoiceMock->expects($this->exactly(1))
