 ...
 */
namespace Aheadworks\StoreCredit\Test\Unit\Block\Html;
...
/**
 * Class Aheadworks\StoreCredit\Test\Unit\Block\Html\PagerTest
 */
class PagerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTemplateProperty()
    {
        ...
        $this->assertEquals('Aheadworks_StoreCredit::html/pager.phtml', $property->getValue($this->object));
    }
