...
namespace Aheadworks\Rma\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\Rma\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_Rma::page/menu/item.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->isCurrent()) {
            /** @var \Aheadworks\Rma\Block\Adminhtml\Page\Menu $menu */
