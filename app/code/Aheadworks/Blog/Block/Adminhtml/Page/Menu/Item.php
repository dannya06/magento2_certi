<?php
namespace Aheadworks\Blog\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\Blog\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_Blog::page/menu/item.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->isCurrent()) {
            /** @var \Aheadworks\Blog\Block\Adminhtml\Page\Menu $menu */
