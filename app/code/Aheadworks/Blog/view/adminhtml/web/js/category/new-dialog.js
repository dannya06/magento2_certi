define([
    ...
    $.widget('awblog.newCategoryDialog', {
        _create: function () {
            var widget = this;
            ...
            this.element.modal({
                ...
                opened: function () {
                    ...
                    $('#new_category_title').val(enteredName);
                    if (enteredName === '') {
                        $('#new_category_title').focus();
                    }
                ...
                closed: function () {
                    ...
                    $('#new_category_title, #new_category_parent-suggest, #new_category_identifier').val('');
                    ...
                    click: function (e) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                identifier: $('#new_category_identifier').val(),
                            ...
                            if (!data.error) {
                                var $suggest = $('#post_cat_id-suggest');

                                $suggest.trigger('selectItem', {
                                    id: data.category.cat_id,
