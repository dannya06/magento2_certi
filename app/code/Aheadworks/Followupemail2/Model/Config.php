...
class Config extends \Magento\Framework\Model\AbstractModel
{
     ...
     */
    const XML_PATH_SENDER = 'followupemail2/general/sender';

    /**
     * Configuration path to test email recipient
     */
    const XML_PATH_TEST_EMAIL_RECIPIENT = 'followupemail2/general/testemail';

    /**
     * Configuration path to enable test mode
     */
    const XML_PATH_ENABLE_TEST_MODE = 'followupemail2/general/enabletestmode';

    /**
     * Configuration path to BCC email address(es)
     */
    const XML_PATH_BCC_EMAIL_ADDRESSES = 'followupemail2/general/bcc_email_addresses';

    /**
     * Configuration path to mail log keep emails for
     */
    const XML_PATH_MAIL_LOG_KEEP_FOR = 'followupemail2/maillog/keepfor';

    /**
     * Configuration path to email header template
     */
    const XML_PATH_EMAIL_HEADER_TEMPLATE = 'followupemail2/header_and_footer/email_header_template';

    /**
     * Configuration path to email footer template
     */
    const XML_PATH_EMAIL_FOOTER_TEMPLATE = 'followupemail2/header_and_footer/email_footer_template';
