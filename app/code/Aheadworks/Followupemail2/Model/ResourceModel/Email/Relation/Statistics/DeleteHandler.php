...
namespace Aheadworks\Followupemail2\Model\ResourceModel\Email\Relation\Statistics;
...
/**
 * Class DeleteHandler
 * @package Aheadworks\Followupemail2\Model\ResourceModel\Email\Relation\Statistics
 * @codeCoverageIgnore
 */
class DeleteHandler implements ExtensionInterface
{
    ...
    public function execute($entity, $arguments = [])
    {
        ...
        $this->statisticsManagement->updateByEmailId($entityId);
