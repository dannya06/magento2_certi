...
namespace Aheadworks\Followupemail2\Model\ResourceModel\Campaign\Relation\Statistics;
...
/**
 * Class DeleteHandler
 * @package Aheadworks\Followupemail2\Model\ResourceModel\Campaign\Relation\Statistics
 * @codeCoverageIgnore
 */
class DeleteHandler implements ExtensionInterface
{
    ...
    public function execute($entity, $arguments = [])
    {
        ...
        $this->statisticsManagement->updateByCampaignId($entityId);
