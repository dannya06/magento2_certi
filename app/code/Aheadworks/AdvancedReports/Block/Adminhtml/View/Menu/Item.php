...
namespace Aheadworks\AdvancedReports\Block\Adminhtml\View\Menu;
 ...
 *
 * @package Aheadworks\AdvancedReports\Block\Adminhtml\View\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_AdvancedReports::view/menu/item.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->isCurrent()) {
            /** @var \Aheadworks\AdvancedReports\Block\Adminhtml\View\Menu $menu */
    ...
    {
        /** @var \Aheadworks\AdvancedReports\Block\Adminhtml\View\Menu */
        $firstCrumb = $this->getParentBlock()->getFirstCrumb();
