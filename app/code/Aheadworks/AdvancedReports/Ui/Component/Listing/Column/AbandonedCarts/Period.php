...
namespace Aheadworks\AdvancedReports\Ui\Component\Listing\Column\AbandonedCarts;
 ...
 * Class Period
 *
 * @package Aheadworks\AdvancedReports\Ui\Component\Listing\Column\AbandonedCarts
 */
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                $item[$this->getName()] = $period['period_label'];
            }
        }
