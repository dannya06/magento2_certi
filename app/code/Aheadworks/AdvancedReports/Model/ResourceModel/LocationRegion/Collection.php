...
namespace Aheadworks\AdvancedReports\Model\ResourceModel\LocationRegion;
 ...
 * Class Collection
 *
 * @package Aheadworks\AdvancedReports\Model\ResourceModel\LocationRegion
 */
class Collection extends \Aheadworks\AdvancedReports\Model\ResourceModel\AbstractCollection
{
    ...
    protected function getColumns($addRate = false)
    {
        ...
        return [
            ...
            'region' => 'IFNULL(main_table.region, "Not Set")',
