...
namespace Aheadworks\AdvancedReports\Model\ResourceModel\CouponCode;

use Magento\Framework\DataObject;
use Aheadworks\AdvancedReports\Model\ResourceModel\CouponCode as ResourceCouponCode;

/**
 * Class Collection
 *
 * @package Aheadworks\AdvancedReports\Model\ResourceModel\CouponCode
 */
class Collection extends \Aheadworks\AdvancedReports\Model\ResourceModel\AbstractCollection
{
    ...
    {
        $this->_init(DataObject::class, ResourceCouponCode::class);
    }
    ...
    protected function _initSelect()
    {
        $this->getSelect()
            ...
            ->group('LOWER(main_table.coupon_code)');
