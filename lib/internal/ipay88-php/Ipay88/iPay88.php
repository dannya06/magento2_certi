...
class IPay88 {
    ...
    public static $paymentMethods = array(
        52  => array('name' => 'Credit Card (BCA)', 'logo' => 'ccbca_s.png'),
        35  => array('name' => 'Credit Card (BRI)', 'logo' => 'ccbri_s.png'),
        42  => array('name' => 'Credit Card (CIMB)', 'logo' => 'cccimb_s.png'),
        56 => array('name' => 'Credit Card (CIMB Authorization)', 'logo' => 'cccimbauth_s.png'),
        35 => array('name' => 'Credit Card (CIMB IPG)', 'logo' => 'cccimbipg_s.png'),
        45 => array('name' => 'Credit Card (Danamon)', 'logo' => 'ccdanamon_s.png'),
        53 => array('name' => 'Credit Card (Mandiri)', 'logo' => 'ccmandiri_s.png'),
        43 => array('name' => 'Credit Card (Maybank)', 'logo' => 'ccmaybank_s.png'),
        54 => array('name' => 'Credit Card (UnionPay)', 'logo' => 'ccunionpay_s.png'),
        46 => array('name' => 'Credit Card (UOB)', 'logo' => 'ccuob_s.png'),

        11 => array('name' => 'CIMB Clicks', 'logo' => 'olcimb_s.png'),
        14 => array('name' => 'Muamalat IB', 'logo' => 'olmuamalat_s.png'),
        23 => array('name' => 'Danamon Online Banking', 'logo' => 'oldanamon_s.png'),

        9 => array('name' => 'Maybank VA', 'logo' => 'atmmaybank_s.png'),
        17 => array('name' => 'Mandiri ATM', 'logo' => 'atmmandiri_s.png'),
        25 => array('name' => 'BCA VA', 'logo' => 'atmbca_s.png'),
        26 => array('name' => 'BNI VA', 'logo' => 'atmbni_s.png'),
        31 => array('name' => 'Permata VA', 'logo' => 'atmpermata_s.png'),

        63 => array('name' => 'OVO', 'logo' => 'ewovo_s.png'),

        19 => array('name' => 'Pay by QR', 'logo' => 'opayqr_s.png'),
    ...
    public static $requeryUrl               = 'https://payment.ipay88.co.id/epayment/enquiry.asp';
    public static $refererHost              = 'www.www.ipay88.co.id';  // Without scheme (http/https).
    public static $recurringUrlSubscription = 'https://www.ipay88.co.id/recurringpayment/webservice/RecurringPayment.asmx/Subscription';
    public static $recurringUrlTermination  = 'https://www.ipay88.co.id/recurringpayment/webservice/RecurringPayment.asmx/Termination';
